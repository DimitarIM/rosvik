    ...
    return (
            <ul className="flex flex-col gap-5 px-2 py-3.5 sm:pr-4 sm:p-4 lg:gap-9 list-none ">
                {gameLoopText.map((list, index) => (
                    <li className="text-sm pl-3.5 relative before:content-[''] before:absolute before:w-[3px] before:h-[3px] before:bg-color-primary before:left-0 before:top-[9px] before:rotate-45 
