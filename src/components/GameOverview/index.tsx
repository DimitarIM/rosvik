...
const GameOverview = ({pageTitle, aboutText, imageOneSrc, imageOneAlt, imageTwoAlt, imageTwoSrc, bgImageAlt, gameLoopTitle, gameLoopText, managementBoxText}: GameOverViewProps) => {
    ...
    <section className="bg-[url(/img/DescriptionPageBgImage.png)] bg-cover bg-no-repeat w-full min-h-screen sm:py-[120px] lg:py-[164px] xl:pt-[170px]"  aria-label={bgImageAlt}>
      <div className="text-text-color  grid grid-cols-1 justify-items-center sm:hidden" >
      ...
      <div className="hidden sm:text-text-color sm:flex justify-self-center ">
        <div className="sm:max-w-fit lg:mr-[10px]" >
          <h1 className="pageTitle sm:text-2xl font-normal text-center 
        ...
        <div className="sm:max-w-fit sm:flex sm:flex-col sm:items-center sm:mr-5">
          ...
          <div className=" mt-4 mb-3 rounded-[10px] bg-[rgba(124,131,133,0.2)] sm:mb-6 sm:max-w-[252px] md:max-w-[290px] md:p-2 lg:max-w-[380px] lg:p-3 lg:pt-7 lg:pb-5 xl:max-w-[413px] xl:pl-4">
            <GameLoopList gameLoopText={gameLoopText} />
          </div>
