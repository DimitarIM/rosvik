    ...
    <>
      ...
      <FooterLogoSection
        ...
        description={
          ...
          <p className="flex flex-col">A team of ambitious students dedicated to creating challenging, complex, or technically ambitious projects. Our work is often marked by creativity, resilience, and a passion for pushing the limits of interactive entertainment.
          </p>
        </div>
        }
      />
